...
import com.sounak.vibebuzz.data.remote.MusicDatabase
    ...
    suspend fun fetchMediaData() = withContext(Dispatchers.IO){
        ...
        songs  = allSongs.map{song ->
            ...
            MediaMetadataCompat.Builder()
                ...
                .putString(METADATA_KEY_DISPLAY_ICON,song.image)
                .putString(METADATA_KEY_MEDIA_URI,song.track_url)
                .putString(METADATA_KEY_ALBUM_ART_URI,song.artistImage)
